"""
Example of how to use this code to make the DMD act as a video projector trough the displayport.
"""
...
dlp.start_pattern() # not sure of this is really needed tbh.